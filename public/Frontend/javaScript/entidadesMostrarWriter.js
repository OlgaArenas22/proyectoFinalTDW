    ...
    try {
        ...
        data.entities.forEach(entityObj => {
            ...
            entidadElemento.innerHTML = `
                <a href="entidadesMostrarWriter.html" onclick="llamarFuncionEntidades(${entity.id})" data-entity="${entity.id}" class="linkIndexEntidad"><strong>${entity.id}: ${entity.name}</strong></a>
                <br>
