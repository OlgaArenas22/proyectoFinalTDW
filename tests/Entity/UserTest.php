...
class UserTest extends TestCase
{
    ...
    public function testRoles(): void
    {
        ...
        static::assertTrue(in_array(Role::INACTIVE, self::$user->getRoles()));
        static::assertFalse(in_array(Role::READER, self::$user->getRoles()));
        static::assertFalse(in_array(Role::WRITER, self::$user->getRoles()));
        ...
        static::assertFalse(self::$user->hasRole(Role::WRITER));
        static::assertFalse(self::$user->hasRole(self::$faker->word()));
        static::assertTrue(in_array(Role::READER, self::$user->getRoles()));
        static::assertFalse(in_array(Role::INACTIVE, self::$user->getRoles()));
        static::assertFalse(in_array(Role::WRITER, self::$user->getRoles()));
        ...
        static::assertFalse(in_array(Role::INACTIVE, self::$user->getRoles()));
        static::assertTrue(in_array(Role::READER, self::$user->getRoles()));
        static::assertTrue(in_array(Role::WRITER, self::$user->getRoles()));
    }
