...
class AssociationControllerTest extends BaseTestCase
{
    ...
    public function testPostAssociation201Created(): array
    {
        ...
        self::assertArrayHasKey('association', $responseAssociation);
        $associationData = $responseAssociation['association'];
        self::assertNotEquals(0, $associationData['id']);
        self::assertSame($a_data['name'], $associationData['name']);
        self::assertSame($a_data['birthDate'], $associationData['birthDate']);
        self::assertSame($a_data['deathDate'], $associationData['deathDate']);
        self::assertSame($a_data['imageUrl'], $associationData['imageUrl']);
        self::assertSame($a_data['wikiUrl'], $associationData['wikiUrl']);
     ...
     */
    #[TestsAttr\Depends('testPostAssociation201Created')]
    public function testCGetAssociations200Ok(): array
    {
        $response = $this->runApp(
            'GET',
            self::RUTA_API,
    ...
    /**
     * Test GET /associations/associationName/{associationName} 204 NO CONTENT
     *
     ...
     *
     * @return array<string,string|int> modified association data
     * @throws JsonException
     */
    #[TestsAttr\Depends('testPostAssociation201Created')]
    ...
    public function testPutAssociation209Updated(array $association, string $etag): array
    {
        ...
        self::assertJson($r_body);
        $association_aux = json_decode($r_body, true, 512, JSON_THROW_ON_ERROR);
        self::assertArrayHasKey('association', $association_aux);
        self::assertSame($association['id'], $association_aux['association']['id']);
        self::assertSame($a_data['name'], $association_aux['association']['name']);
        self::assertSame($a_data['birthDate'], $association_aux['association']['birthDate']);
        self::assertSame($a_data['deathDate'], $association_aux['association']['deathDate']);
        self::assertSame($a_data['imageUrl'], $association_aux['association']['imageUrl']);
        self::assertSame($a_data['wikiUrl'], $association_aux['association']['wikiUrl']);
    ...
    {
        $a_data = [ 'name' => self::$faker->words(3, true) ];
        $this->runApp(
            'POST',
            self::RUTA_API,
            $a_data,
    ...
    /**
     * Test PUT /association/{associationId} 412 PRECONDITION_FAILED
     *
     * @param array<string,string|int> $association data returned by testPutAssociation209Updated()
     */
    #[TestsAttr\Depends('testPutAssociation209Updated')]
    public function testPutAssociation412PreconditionFailed(array $association): void
    {
        $response = $this->runApp(
            'PUT',
            self::RUTA_API . '/' . $association['id'],
    ...
    /**
     * Test OPTIONS /associations[/{associationId}] NO CONTENT
     */
    ...
    #[TestsAttr\Depends('testPutAssociation412PreconditionFailed')]
    #[TestsAttr\Depends('testGetAssociationName204NoContent')]
