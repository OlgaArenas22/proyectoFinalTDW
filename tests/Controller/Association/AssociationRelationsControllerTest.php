...
final class AssociationRelationsControllerTest extends BaseTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$association = AssociationFactory::createElement(self::$faker->word());
     ...
     * OPTIONS /associations/{associationId}/entities/add/{idEntity}
     */
    ...
    /**
     * PUT /associations/{associationId}/entities/add/{idEntity}
     */
    ...
    /**
     * PUT /associations/{associationId}/entities/rem/{idEntity}
     *
     * @return void
     * @throws JsonException
     */
